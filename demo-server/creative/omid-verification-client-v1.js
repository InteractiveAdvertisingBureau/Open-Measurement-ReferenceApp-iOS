...
var module$exports$omid$common$constants = {AdEventType:{IMPRESSION:"impression", STATE_CHANGE:"stateChange", GEOMETRY_CHANGE:"geometryChange", SESSION_START:"sessionStart", SESSION_ERROR:"sessionError", SESSION_FINISH:"sessionFinish", LOADED:"loaded", START:"start", FIRST_QUARTILE:"firstQuartile", MIDPOINT:"midpoint", THIRD_QUARTILE:"thirdQuartile", COMPLETE:"complete", PAUSE:"pause", RESUME:"resume", BUFFER_START:"bufferStart", BUFFER_FINISH:"bufferFinish", SKIPPED:"skipped", VOLUME_CHANGE:"volumeChange", 
...
var module$exports$omid$common$DetectOmid = {OMID_PRESENT_FRAME_NAME:"omid_v1_present", isOmidPresent:function(a) {
  return a.frames && module$exports$omid$common$DetectOmid.OMID_PRESENT_FRAME_NAME in a.frames ? !0 : !1;
...
var module$exports$omid$common$logger = {error:function(a) {
  ...
  if ("undefined" !== typeof jasmine && jasmine) {
  ...
  "undefined" !== typeof console && console && console.error && console.error.apply(console, [].concat($jscomp.arrayFromIterable(b)));
}};
var module$exports$omid$common$PostMessageCommunication = function(a, b) {
  b = void 0 === b ? omidGlobal : b;
...
module$exports$omid$common$PostMessageCommunication.prototype.sendMessage = function(a, b) {
  ...
  b.postMessage(JSON.stringify(a.serialize()), "*");
};
...
var module$exports$omid$common$version = {Version:"1.0.0"};
var module$contents$omid$verificationClient$VerificationClient_MESSAGE_VERSION = module$exports$omid$common$version.Version, module$contents$omid$verificationClient$VerificationClient_EventCallback, module$exports$omid$verificationClient$VerificationClient = function(a) {
  this.communication = a = void 0 === a ? (0,module$exports$omid$common$serviceCommunication.startServiceCommunication)(omidGlobal, ["omid", "v1_VerificationServiceCommunication"]) : a;
...
module$exports$omid$verificationClient$VerificationClient.prototype.injectJavaScriptResource = function(a, b, c, d) {
  var e = this;
  (0,module$exports$omid$common$argsChecker.assertTruthyString)("url", a);
  if (omidGlobal.document) {
    this.injectJavascriptResourceUrlInDom_(a, b, c);
  } else {
    if (!d && "undefined" === typeof verificationClientId) {
      throw Error("DOM missing and verificationClientId not found, cannot injectJavaScriptResource successfully.");
    }
    this.sendMessage_("injectJavaScriptResource", function(d, f) {
      d ? (e.evaluateJavaScript_(f, a), b()) : (module$exports$omid$common$logger.error("Service failed to load JavaScript resource."), c());
    }, d || verificationClientId, a);
  }
};
module$exports$omid$verificationClient$VerificationClient.prototype.injectJavascriptResourceUrlInDom_ = function(a, b, c) {
  var d = omidGlobal.document, e = d.body;
...
module$exports$omid$verificationClient$VerificationClient.prototype.setTimeout = function(a, b) {
  ...
  if (this.hasTimeoutMethods_()) {
    return omidGlobal.setTimeout(a, b);
  }
...
module$exports$omid$verificationClient$VerificationClient.prototype.clearTimeout = function(a) {
  ...
  this.hasTimeoutMethods_() ? omidGlobal.clearTimeout(a) : this.sendOneWayMessage_("clearTimeout", a);
};
module$exports$omid$verificationClient$VerificationClient.prototype.setInterval = function(a, b) {
  (0,module$exports$omid$common$argsChecker.assertFunction)("functionToExecute", a);
  (0,module$exports$omid$common$argsChecker.assertPositiveNumber)("timeInMillis", b);
  if (this.hasIntervalMethods_()) {
    return omidGlobal.setInterval(a, b);
  }
...
module$exports$omid$verificationClient$VerificationClient.prototype.clearInterval = function(a) {
  ...
  this.hasIntervalMethods_() ? omidGlobal.clearInterval(a) : this.sendOneWayMessage_("clearInterval", a);
};
module$exports$omid$verificationClient$VerificationClient.prototype.hasTimeoutMethods_ = function() {
  return "function" === typeof omidGlobal.setTimeout && "function" === typeof omidGlobal.clearTimeout;
};
module$exports$omid$verificationClient$VerificationClient.prototype.hasIntervalMethods_ = function() {
  return "function" === typeof omidGlobal.setInterval && "function" === typeof omidGlobal.clearInterval;
};
