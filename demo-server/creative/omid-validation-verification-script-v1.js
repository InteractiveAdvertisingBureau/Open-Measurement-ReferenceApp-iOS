...
var module$exports$omid$common$version = {Version:"1.0.2-dev"};
...
var module$contents$omid$validationVerificationScript$ValidationVerificationClient_DefaultLogServer = "http://pandora-omid-test/sendMessage?msg=", module$exports$omid$validationVerificationScript$ValidationVerificationClient = function(a, b) {
  ...
  }, this.vendorKey_), Object.keys(module$exports$omid$common$constants.AdEventType).forEach(function(a) {
    module$exports$omid$common$constants.AdEventType[a] != module$exports$omid$common$constants.AdEventType.VIDEO && c.verificationClient_.addEventListener(module$exports$omid$common$constants.AdEventType[a], function(a) {
...
module$exports$omid$validationVerificationScript$ValidationVerificationClient.prototype.sendPreviousLogs_ = function() {
  this.logs_.forEach(function(a) {
    this.sendUrl_(a);
  }.bind(this));
};
module$exports$omid$validationVerificationScript$ValidationVerificationClient.prototype.sessionObserverCallback_ = function(a) {
  if (a.type == module$exports$omid$common$constants.AdEventType.SESSION_START) {
    this.sessionStart_ = !0;
    var b = a.data.verificationParameters;
    null != b && " " != b && (this.logServer_ = b);
    this.sendPreviousLogs_();
  }
  this.logMessage_(a, a.timestamp);
};
module$exports$omid$validationVerificationScript$ValidationVerificationClient.prototype.getLogs = function() {
  return this.logs_;
};
var module$exports$validationVerificationClientMain = {};
new module$exports$omid$validationVerificationScript$ValidationVerificationClient(new module$exports$omid$verificationClient$VerificationClient, "dummyVendor");
