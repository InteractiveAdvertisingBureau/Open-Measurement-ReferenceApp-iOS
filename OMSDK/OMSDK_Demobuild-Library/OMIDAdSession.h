 ...
 */
@interface OMIDDemobuildAdSession : NSObject

/*!
 * @abstract The AdSession configuration is used for check owners.
 */
@property(nonatomic, readonly, nonnull) OMIDDemobuildAdSessionConfiguration *configuration;
/*!
 ...
 */
- (nullable instancetype)initWithConfiguration:(nonnull OMIDDemobuildAdSessionConfiguration *)configuration
                              adSessionContext:(nonnull OMIDDemobuildAdSessionContext *)context
