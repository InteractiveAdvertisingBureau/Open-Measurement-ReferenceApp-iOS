 ...
 */
@interface OMIDPandoraAdSession : NSObject

/*!
 * @abstract The AdSession configuration is used for check owners.
 */
@property(nonatomic, readonly, nonnull) OMIDPandoraAdSessionConfiguration *configuration;
/*!
 ...
 */
- (nullable instancetype)initWithConfiguration:(nonnull OMIDPandoraAdSessionConfiguration *)configuration
                              adSessionContext:(nonnull OMIDPandoraAdSessionContext *)context
