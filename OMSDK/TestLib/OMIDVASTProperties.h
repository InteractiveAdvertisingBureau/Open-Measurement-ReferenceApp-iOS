...
/*!
 * @abstract List of supported media player positions.
 */
...
/*!
 * @abstract This method enables the media player to create a new VAST properties instance for skippable media ad placement.
 *
...
/*!
 * @abstract This method enables the media player to create a new VAST properties instance for non-skippable media ad placement.
 *
 * @param autoPlay Determines whether the media will auto-play content.
 * @param position The position of the media in relation to other content.
 * @return A new instance of VAST properties.
...
/*!
 *@abstract This method should not be called by the integration
 */
