 ...
 */
@interface OMIDPandoraAdSessionContext : NSObject
 ...
 * @see OMIDSDK
 */
- (nullable instancetype)initWithPartner:(nonnull OMIDPandoraPartner *)partner
...
- (nullable instancetype)initWithPartner:(nonnull OMIDPandoraPartner *)partner
                               ...
                               resources:(nonnull NSArray<OMIDPandoraVerificationScriptResource *> *)resources
               customReferenceIdentifier:(nullable NSString *)customReferenceIdentifier
                                   error:(NSError *_Nullable *_Nullable)error;
