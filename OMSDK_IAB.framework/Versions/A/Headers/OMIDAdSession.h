 ...
 */
@interface OMIDIABAdSession : NSObject

/*!
 * @abstract The AdSession configuration is used for check owners.
 */
@property(nonatomic, readonly, nonnull) OMIDIABAdSessionConfiguration *configuration;
/*!
 ...
 */
- (nullable instancetype)initWithConfiguration:(nonnull OMIDIABAdSessionConfiguration *)configuration
                              adSessionContext:(nonnull OMIDIABAdSessionContext *)context
