 ...
 */
@interface OMIDIABAdSessionContext : NSObject
 ...
 * @see OMIDSDK
 */
- (nullable instancetype)initWithPartner:(nonnull OMIDIABPartner *)partner
...
- (nullable instancetype)initWithPartner:(nonnull OMIDIABPartner *)partner
                               ...
                               resources:(nonnull NSArray<OMIDIABVerificationScriptResource *> *)resources
               customReferenceIdentifier:(nullable NSString *)customReferenceIdentifier
                                   error:(NSError *_Nullable *_Nullable)error;
